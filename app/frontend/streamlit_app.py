...
def handle_userinput(user_question, answer):
    ...
    st.session_state.chat_history = st.session_state.chat_history + "You: \n" + user_question + "\n "

    st.session_state.chat_history = st.session_state.chat_history + "Chatbot: \n" + answer + "\n"
...
def main():
    ...
    if user_question:
        ...
        reply = requests.post(URL+"ask", json= {"question" :  full_text})
        result = reply.json()
